...
function Navbar(){
    return(
        ...
        <header className="bg-primary p-3">
            <div className="container d-flex flex-wrap aling-items-center justify-content-between">
                <h1>Punto Nieve</h1>
                <form className="d-flex mx-3" role="search" style={{flex: "1 1 auto",maxWidth:"400"}}>
